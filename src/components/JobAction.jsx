    ...
    return (
        <div className="py-4 md:py-6 md:pl-6 max-w-sm px-6">
            <div className="flex items-center gap-4">
                <button className="px-2 md:px-7 py-2 border rounded-lg border-[#dc4a2d] text-[#dc4a2d] bg-[#FEF4F2] tracking-wider text-base shadow-md font-semibold"><Trash2 className='w-4 inline-block mr-2' />Delete job</button>
                <button className="px-2 md:px-7 py-2 shadow-inner drop-shadow-md rounded-lg bg-[#dc4a2d] text-white border text-base md:font-semibold"><Pencil className="w-4 inline-block mr-2" />Edit job</button>
            </div>
