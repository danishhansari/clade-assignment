        ...
        <div className="py-4 md:py-6 md:pl-6 max-w-sm px-6">
            ...
            <div className="flex flex-col mt-8 gap-4">
                <div className="flex py-4 border-b justify-between pr-2">
                    <p className='text-gray-500 font-medium tracking-wide'><Users className='inline-block mr-2' />Applicants</p>
                    <p className='text-lg text-gray-500 font-semibold tracking-wider'>400</p>
                </div>
                <div className="flex py-4 border-b justify-between pr-2">
                    <p className='text-gray-500 font-medium tracking-wide'><UserRoundCheck className='inline-block mr-2' />Matches</p>
                    <p className='text-lg text-gray-500 font-semibold tracking-wider'>100</p>
                </div>
                <div className="flex py-4 border-b justify-between pr-2">
                    <p className='text-gray-500 font-medium tracking-wide'><MessageSquare className='inline-block mr-2' />Messages</p>
                    <p className='text-lg text-gray-500 font-semibold tracking-wider'>147</p>
                </div>
                <div className="flex py-4 justify-between pr-2">
                    ...
                    <p className='text-lg text-gray-500 font-semibold tracking-wider'>800</p>
                </div>
            </div>
        </div>
    )
